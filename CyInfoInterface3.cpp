...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvCultureLevelInfo, python::bases<CvInfoBase> >("CvCultureLevelInfo")
		...
		.def("getCityRadius", &CvCultureLevelInfo::getCityRadius, "int ()") // Mylon - Enhanced Sized Cities - For interface use
		.def("getCultureHappiness", &CvCultureLevelInfo::getCultureHappiness, "int ()") // Mylon - Enhanced Sized Cities - For interface use
		.def("getCultureHealth", &CvCultureLevelInfo::getCultureHealth, "int ()") // Mylon - Enhanced Sized Cities - For interface use
		;
	...
	python::class_<CvEspionageMissionInfo, python::bases<CvInfoBase> >("CvEspionageMissionInfo")
		...
		.def("getStealOil", &CvEspionageMissionInfo::getStealOil, "int ()")
