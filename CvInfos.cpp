...
int CvCultureLevelInfo::getCultureHealth() const
{
    return m_iCultureHealth;
}
// Mylon - Enhanced Size Cities
...
bool CvCultureLevelInfo::read(CvXMLLoadUtility* pXml)
{
	...
	pXml->GetChildXmlValByName(&m_iCultureHappiness, "iCultureHappiness");

	pXml->GetChildXmlValByName(&m_iCultureHealth, "iCultureHealth");
	// Mylon - Enhanced Size Cities
